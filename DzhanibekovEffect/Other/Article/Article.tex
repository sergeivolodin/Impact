...
\end{equation}
%проблема с тем, что cos\theta не принимает значения -1 и 1, что неудобно.
%Введем угол между вектором \begin{math} K \end{math}
...
%правильное o()
%здесь проблема со знаком \varepsilon, т.е. разобран один из случаев. Разобрать второй!
...
%Вычислим интеграл \ref{timeFinalEquation} для
%\begin{equation}
%x_1=0,x_2=x(q_2)=
%\end{equation}

\subsection{Вид движения}
%получить выражение для q(t) или добавить график из численного решения
\end{document}
